...
- Erreicht der Bikini-Avatar das Levelziel, wird vor der Upgrade-Auswahl beziehungsweise dem Finale eine fünfsekündige, nicht explizite Vollbild-Tanzsequenz über der weiterlaufenden Levelmusik angezeigt. Sie nutzt einen vorbereiteten 16-Bilder-Sprite-Zyklus, damit die Laufzeit auf Mobilgeräten gering bleibt. Eine spätere, echte 3D-Skelettanimation ist als mögliche Ausbaustufe vorgemerkt, aber nicht begonnen.
