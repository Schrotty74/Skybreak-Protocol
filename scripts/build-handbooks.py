...
TEXT = {
    "de": {
        ...
        "systems_cards": [
            ...
            ("UPGRADES & LEVEL", "Jedes Level hat 15 Etagen und eine gleichbleibende Welt. Nach dem Abschluss Kraft oder Design wählen; danach wird das nächste Level lokal freigeschaltet."),
    ...
    "en": {
        ...
        "systems_cards": [
            ...
            ("UPGRADES & LEVELS", "Each level has 15 floors and one consistent world. After completion, choose power or style; the next level then unlocks locally."),
