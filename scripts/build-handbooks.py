...
TEXT = {
    "de": {
        ...
        "systems_cards": [
            ...
            ("ZIELE & EISPICKEL", "Je zwei Energiezellen oder Zugangsschalter müssen vor dem Levelziel aktiviert werden. Ihre Gestalt passt sichtbar zum Level, die Funktion bleibt gleich. Der Eispickel löst gegnerische Projektile auf und knackt Schilde. Ein erster Treffer friert einen normalen Gegner ein, der nächste schaltet ihn aus. Ab Kraft 4 entsteht kurz eine Eisbrücke."),
            ("WÄCHTER & LEVEL", "Jedes Level hat 15 Etagen, eine eigene faire Routenkarte, Kulisse, Bossarena und ein Eispickel-Grundmodell. Werte für Bewegung, Schüsse und Gefahren bleiben innerhalb einer Schwierigkeit über alle Level gleich. Nach Sieg folgt die nächste Upgrade-Vorschau."),
        ...
        "settings_cards": [
            ...
            ("AUDIO", "Jedes Level besitzt einen eigenen Track. Level 1 bis 10 verwenden unterschiedliche samplefreie Retro-Arcade-Arrangements. MUSIC und SFX lassen sich vollständig getrennt schalten."),
    ...
    "en": {
        ...
        "systems_cards": [
            ...
            ("OBJECTIVES & ICE PICK", "Two energy cells or access switches must be activated before the level goal. Their shape visibly matches the level while their function stays the same. The ice pick dissolves enemy projectiles and breaks shields. A first hit freezes a normal enemy; the next disables it. From power 4, it briefly creates an ice bridge."),
            ("GUARDIANS & LEVELS", "Each level has 15 floors, a unique fair route blueprint, scenery, boss arena, and ice-pick base model. Movement, shots, and hazards use the same values across all levels within one difficulty. The next upgrade preview follows a win."),
        ...
        "settings_cards": [
            ...
            ("AUDIO", "Every level has its own track. Levels 1 to 10 use distinct sample-free retro-arcade arrangements. MUSIC and SFX are completely independent."),
