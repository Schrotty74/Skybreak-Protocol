...
TEXT = {
    "de": {
        ...
        "intro": "Skybreak Protocol ist ein vertikales Cyberpunk-Arcade-Spiel. Steuere den Kletterroboter durch zehn Sektoren, durchbrich Plattformen von unten, schalte Drohnen aus und erreiche den Sendeturm.",
        ...
        "start_steps": [
            ...
            "Beim Levelwechsel Kraft oder Design des Eispickels verbessern.",
            "Nach einem Lauf ein freigeschaltetes Startlevel auswählen.",
        ],
        ...
        "buttons": [
            ...
            ("GRAPHICS", "Grafik", "Niedrig, Mittel, Hoch oder Ultra auswählen."),
        ...
        "systems_cards": [
            ("PLATTFORMEN", "Beschädigte Module lassen sich von unten oder mit dem Eispickel zerstören. Lücken zwingen zu kontrollierten Sprüngen."),
            ...
            ("UPGRADES & LEVEL", "Nach jedem neuen Level Kraft oder Design wählen. Erreichte Level werden lokal freigeschaltet und können nach einem Lauf direkt als neuer Startpunkt gewählt werden."),
            ("PUNKTE", "Schwer erhöht den Multiplikator. Reguläre Läufe speichern den lokalen Rekord; Cheat-Läufe verändern ihn nicht."),
        ],
        "levels_a": "LEVEL 1 BIS 5",
        "levels_b": "LEVEL 6 BIS 10",
        "levels": [
            (1, "Neon Undercity", "Cyan-magenta Unterstadt mit Scanbalken. Einstieg in Bewegung, Sprünge und erste Drohnen."),
            (2, "Chrome Bazaar", "Pink, Mint und Chrom mit Hologrammrahmen. Engere Wege und höheres Tempo."),
            (3, "Toxic Transit", "Giftgrüne Transit-Infrastruktur und Energieblasen. Gefahren verlangen genauere Sprünge."),
            (4, "Crimson Firewall", "Rot-orange Sicherheitszone mit Firewall-Säulen. Dichtere Drohnen- und Gefahrenmuster."),
            (5, "Azure Data Sea", "Tiefblauer Datenbezirk mit digitalen Wellen. Die Mitte des Aufstiegs prüft Rhythmus und Positionierung."),
            (6, "Violet Reactor", "Violetter Energiekern mit Reaktorringen. Weniger Ruhe zwischen Angriffen und Sprüngen."),
            (7, "Solar Megagrid", "Bernsteinrotes Energienetz mit Solarleuchten. Schnelle Gefahren und anspruchsvollere Wege."),
            (8, "Ghost Network", "Blass-cyanfarbene Netzruinen mit Lichtspuren. Orientierung und Rückwege werden wichtiger."),
            (9, "Quantum Rift", "Violett-blaue Dimensionszone. Hohe Gegnerdichte und kurze Reaktionsfenster."),
            (10, "Skybreak Apex", "Leuchtender Gipfel mit Sendestrahlen. Letzter Aufstieg zum Transmissionsturm."),
        ],
        ...
        "settings_cards": [
            ...
            ("GRAFIK", "Mittel wird am Smartphone empfohlen. Ultra aktiviert maximale Effekte und kann das Gerät stark erwärmen. Bei Hitze oder direkter Sonne nicht verwenden."),
    ...
    "en": {
        ...
        "intro": "Skybreak Protocol is a vertical cyberpunk arcade game. Guide the climbing robot through ten sectors, break platforms from below, disable drones, and reach the transmission tower.",
        ...
        "start_steps": [
            ...
            "At each level transition, upgrade ice-pick power or style.",
            "After a run, select any unlocked starting level.",
        ],
        ...
        "buttons": [
            ...
            ("GRAPHICS", "Graphics", "Select Low, Medium, High, or Ultra."),
        ...
        "systems_cards": [
            ("PLATFORMS", "Break damaged modules from below or with the ice pick. Gaps require controlled jumps."),
            ...
            ("UPGRADES & LEVELS", "Choose power or style after reaching a new level. Reached levels unlock locally and can be selected directly as the next starting point after a run."),
            ("SCORING", "Hard increases the multiplier. Normal runs save the local record; cheat runs do not change it."),
        ],
        "levels_a": "LEVELS 1 TO 5",
        "levels_b": "LEVELS 6 TO 10",
        "levels": [
            (1, "Neon Undercity", "Cyan-magenta city depths with scan bars. Introduction to movement, jumping, and the first drones."),
            (2, "Chrome Bazaar", "Pink, mint, and chrome with holographic frames. Tighter paths and faster pacing."),
            (3, "Toxic Transit", "Toxic green transit infrastructure and energy bubbles. Hazards demand more precise jumps."),
            (4, "Crimson Firewall", "Red-orange security zone with firewall columns. Denser drone and hazard patterns."),
            (5, "Azure Data Sea", "Deep-blue data district with digital waves. The midpoint tests rhythm and positioning."),
            (6, "Violet Reactor", "Violet energy core with reactor rings. Less recovery time between attacks and jumps."),
            (7, "Solar Megagrid", "Amber-red energy grid with solar glow. Faster hazards and more demanding routes."),
            (8, "Ghost Network", "Pale-cyan network ruins with light trails. Orientation and return routes become important."),
            (9, "Quantum Rift", "Purple-blue dimensional zone. High enemy density and short reaction windows."),
            (10, "Skybreak Apex", "Bright summit with transmission rays. Final ascent to the tower."),
        ],
        ...
        "settings_cards": [
            ...
            ("GRAPHICS", "Medium is recommended on phones. Ultra enables maximum effects and can make the device very warm. Avoid it in heat or direct sunlight."),
