...
TEXT = {
    "de": {
        ...
        "systems_cards": [
            ("PLATTFORMEN", "Jedes Level besitzt ein eigenes Material: Kryostahl, Chrom-Eis, Korrosionseis, Schmelzglas, Tiefeneis, Plasmakristall, Solarfelder, Phaseneis, Riftkristall oder Apex-Eis. Beschädigte Module lassen sich von unten oder mit dem Eispickel zerstören."),
    ...
    "en": {
        ...
        "systems_cards": [
            ("PLATFORMS", "Every level has its own material: cryo steel, chrome ice, corroded ice, molten glass, deep ice, plasma crystal, solar arrays, phase ice, rift crystal, or apex ice. Damaged modules can be destroyed from below or with the ice pick."),
